...
private int modeOfTreatmentIdNumber;
private int treatmentIdNumber;
private String modeOfTreatment;
public int getModeOfTreatmentIdNumber() {
	return modeOfTreatmentIdNumber;
}
public void setModeOfTreatmentIdNumber(int modeOfTreatmentIdNumber) {
	this.modeOfTreatmentIdNumber = modeOfTreatmentIdNumber;
}
