...
public class BaselineLaboratoryDataLymphoma {
	private int baselineLaboratoryDataLymphoma;
	...
	public int getBaselineLaboratoryDataLymphoma() {
		return baselineLaboratoryDataLymphoma;
	}

	public void setBaselineLaboratoryDataLymphoma(int baselineLaboratoryDataLymphoma) {
		this.baselineLaboratoryDataLymphoma = baselineLaboratoryDataLymphoma;
	}
