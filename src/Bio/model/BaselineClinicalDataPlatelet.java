...
public class BaselineClinicalDataPlatelet {
	private int baselineGeneralDataPlateletId;
	...
	private String splenomegalyMeasurement;
	private String skin;
	private String otherFindings;

	public int getBaselineGeneralDataPlateletId() {
		return baselineGeneralDataPlateletId;
	}

	public void setBaselineGeneralDataPlateletId(int baselineGeneralDataPlateletId) {
		this.baselineGeneralDataPlateletId = baselineGeneralDataPlateletId;
	}
	...
	public String getSplenomegalyMeasurement() {
		return splenomegalyMeasurement;
	}

	public void setSplenomegalyMeasurement(String splenomegalyMeasurement) {
		this.splenomegalyMeasurement = splenomegalyMeasurement;
	}
