...
public class BaselineClinicalDataLymphoma {
	private int baselineClinicalDataLymphomaId;
	...
	public int getBaselineClinicalDataLymphomaId() {
		return baselineClinicalDataLymphomaId;
	}

	public void setBaselineClinicalDataLymphomaId(int baselineClinicalDataLymphomaId) {
		this.baselineClinicalDataLymphomaId = baselineClinicalDataLymphomaId;
	}
	...
	public void setStageOfDisease(String stageOfDisease) {
